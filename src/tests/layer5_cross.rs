...
// ── BCJ2 cross-validation (decode-only; 4-stream via bcjzippy sub-crate) ──
...
// ── AES cross-validation (decode-only; via aeszippy sub-crate) ──────────────
...
/// through `encode_bcj2_folder` → `bcjzippy::encode::encode_4streams` +
